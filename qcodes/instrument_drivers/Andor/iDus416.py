...
class Andor_iDus(Instrument):
    def __init__(self, name: str, dll_path: str=None, **kwargs):
        ...
        self.add_parameter('acquisition_mode',
                           ...
                           get_parser=lambda x: self._generic_parser('AcquisitionMode'),
                           val_mapping={'Unset': -1,
                                        'Single': 1,
                                        'Accumulate': 2,
                                        'Kinetic': 3,
        ...
        self.add_parameter('read_mode',
                           ...
                           unit=None,
                           get_cmd=lambda: self.andor.ReadMode,
                           set_cmd=self.andor.SetReadMode,
                           get_parser=lambda x: self._generic_parser('ReadMode'),
                           val_mapping={'Unset': -1,
                                        'FVB': 0,
                                        'Multi-Track': 1,
                                        'Random-Track': 2,
        ...
        self.add_parameter('trigger_mode',
                           ...
                           unit=None,
                           get_cmd=lambda: self.andor.TriggerMode,
                           set_cmd=self.andor.SetTriggerMode,
                           get_parser=lambda x: self._generic_parser('TriggerMode'),
                           val_mapping={'Unset': -1,
                                        'Internal': 0,
                                        'External': 1,
                                        'External Start': 6,
        ...
        self.add_parameter('exposure_time',
                           ...
                           unit='s',
                           get_cmd=lambda: self.andor.exposure,
        ...
        self.add_parameter('accumulation_cycle_time',
                           ...
                           unit='s',
                           get_cmd=lambda: self.andor.accumulate,
        ...
        self.add_parameter('kinetic_cycle_time',
                           ...
                           unit='s',
                           get_cmd=lambda: self.andor.kinetic,
        ...
        self.add_parameter('number_accumulations',
                           ...
                           unit=None,
                           get_cmd=lambda: self.andor.accumulations,
        ...
        self.add_parameter('number_kinetics',
                           ...
                           unit=None,
                           get_cmd=lambda: self.andor.scans,
        ...
        self.add_parameter('preamp_gain',
                           ...
                           vals=validators.Ints(min_value=0,
                                                max_value=self.number_preamp_gains()-1))
    ...
    def get_images(self, data=[]):
        ...
        return self.andor.imageArray, validfirst, validlast
    
    def take_spectrum(self, data=[]):
        """
        Starts acquisition of data and retrieves it from the buffer.
        """
