...
class Keithley_2401(VisaInstrument):
    """
    QCoDeS driver for the Keithley 2401 voltage source.
    This is basically the Keithley 2400 driver with an added "format" function.
    The format has to be "VOLT, CURR" for this driver to work.
    """
    def __init__(self, name, address, **kwargs):
        ...
        self.format('VOLT, CURR')
        """
        Added format parameter, as the format has to be set to 'VOLT, CURR' 
        for this driver to work properly. In case you have trouble with reading
        out the current, check if this setting is correct. Now it will choose
        the correct setting on startup.
        """
